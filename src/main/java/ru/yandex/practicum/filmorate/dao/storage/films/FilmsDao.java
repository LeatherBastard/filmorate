...
public interface FilmsDao {
    ...
    String GET_BY_ID_FILM_QUERY = "SELECT * FROM films WHERE film_id = ?";
    String GET_ALL_FILMS_QUERY = "SELECT * FROM films";
    String GET_MOST_POPULAR_FILMS_QUERY = "SELECT film_id FROM films ORDER BY rate DESC LIMIT ?";
