...
public interface FilmsDao {
    ...
    String GET_BY_ID_FILM_QUERY = "SELECT f.film_id,f.name,f.description,f.release_date,f.duration,f.rate,f.rating_id,r.name AS rating_name, r.description AS rating_description FROM films AS f " +
            "JOIN ratings AS r ON f.rating_id=r.rating_id WHERE f.film_id = ?";
    String GET_ALL_FILMS_QUERY = "SELECT f.film_id,f.name,f.description,f.release_date,f.duration,f.rate,f.rating_id,r.name AS rating_name, r.description AS rating_description FROM films AS f " +
            "JOIN ratings AS r ON f.rating_id=r.rating_id";
    String GET_MOST_POPULAR_FILMS_QUERY = "SELECT f.film_id,f.name,f.description,f.release_date,f.duration,f.rate,f.rating_id,r.name AS rating_name, r.description AS rating_description FROM films AS f " +
            "JOIN ratings AS r ON f.rating_id=r.rating_id " +
    ...
    String RATING_DESCRIPTION_FILMS_COLUMN = "rating_description";
